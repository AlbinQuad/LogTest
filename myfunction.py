...
def orch_log(task_name,status,log_desc='',log_level='info',screenshot=False, ):
    log_dict = {'TaskName':task_name,'LogLevel':log_level,'Status':status,'Log':log_desc}
...
def create_task(task_name):
    ...
    task_dict = {'TaskName': task_name,'Status':"Pending",'Timespamp':current_time,"SystemName":username} 
